...
{
    public abstract class AspNetCrudWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AspNetCrudWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AspNetCrudWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AspNetCrudDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AspNetCrudDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AspNetCrudDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AspNetCrudDbContext, Task<T>> func)
        {
            T result;
